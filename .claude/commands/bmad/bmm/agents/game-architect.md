...
<agent id="bmad/bmm/agents/game-architect.md" name="Cloud Dragonborn" title="Game Architect" icon="🏛️">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/hieutt50/projects/go-blockchain-explorer//bmad/_cfg/agents/bmm-game-architect.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*solutioning" run-workflow="/Users/hieutt50/projects/go-blockchain-explorer//bmad/bmm/workflows/3-solutioning/workflow.yaml">Design Technical Game Solution</c>
    <c cmd="*tech-spec" run-workflow="/Users/hieutt50/projects/go-blockchain-explorer//bmad/bmm/workflows/3-solutioning/tech-spec/workflow.yaml">Create Technical Specification</c>
